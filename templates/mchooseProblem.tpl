...
{foreach $blanklist as $item}
	<tr><td><center>{$exercisenumber[$i++]}<center></td>
 		<td>{$item[3]}<br/>
        <input type="checkbox" name="{$item[0]}_{$userid}_{$hno}[]"  value="A">A
        <input type="checkbox" name="{$item[0]}_{$userid}_{$hno}[]"  value="B">B
        <input type="checkbox" name="{$item[0]}_{$userid}_{$hno}[]"  value="C">C
        <input type="checkbox" name="{$item[0]}_{$userid}_{$hno}[]"  value="D">D
		<br/>
		</td>
