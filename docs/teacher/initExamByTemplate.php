...
//                $knum = implode("%",$knum);
		...
		$insertquery = "INSERT INTO Exam VALUES ('','$choosetemplate[2]','$ename','$releasedate','$deadline','$time','$choosetemplate[3]','$stage','$final','$singletemplatenum','$singlechoosestring','$multitemplatenum','$multichoosestring','$filltemplatenum','$fillstring')";
