...
//    $chapterNo='10120081001';
    ...
    echo "<table border='1'>";
    echo "<form action='add_tiankongti.php' method=POST>
          <tr>
          <td>习题编号</td>
...
//            $title=$_POST['title'];
            ...
            include "connect_MySQL.php";
            $b=$chapterNo.$num;
            $a="select addExercise('$b', '$chapterNo','填空题','$blank','$answer','填空')";
            $result = mysqli_query($link,$a);
            $flag = mysqli_fetch_row($result);
            
            if ($flag[0] == 1) {
		        echo "操作成功，2秒后跳转";		
		        echo"<meta http-equiv=\"refresh\" content=\"1;url=chapter_view_teacher.php.php\">"; 
		    }
	        else{
		        echo "操作失败，2秒后跳转";		
		        echo"<meta http-equiv=\"refresh\" content=\"1;url=add_tiankongti.php\">"; 
	}
        }
 //   }
 ?>